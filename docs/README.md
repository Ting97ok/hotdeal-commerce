...
> 상태: 인증(JWT·RTR)·회원 구현 완료 · 핫딜 설계 확정(PRD·기술 가설·ERD·ADR 9건) · 엔티티+마이그레이션(상품·핫딜·재고·주문·결제, V2~V6) 완료 → 슬라이스 0(핫딜 등록/조회) 착수 예정.
...
- 🚧 다음: 슬라이스 0(핫딜 등록/조회)부터 vertical TDD
...
| 5 | [ADR](adr/README.md) → 관심 결정 | 각 결정의 대안·트레이드오프. 추천: [0004 선점·복원](adr/0004-stock-reservation-lifecycle.md) · [0006 불변식·방어](adr/0006-correctness-invariants-defense-layers.md) · [0009 동시성](adr/0009-stock-concurrency-design.md) · [0008 결제·어댑터](adr/0008-payment-model-pg-boundary.md) |
