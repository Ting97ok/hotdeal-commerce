...
- 함의: 선착순에서 "거의 맞음"은 실패다. **오버셀 0 / 거짓 성공 0** 이 헤드라인 정확성 요구 — 올리브영의 '미발급'은 성공 응답 후 미지급, 즉 **거짓 성공**이다(재고가 남은 채 정직하게 실패하는 "덜 팔림"과 구분 — [ADR-0006](../adr/0006-correctness-invariants-defense-layers.md)).
